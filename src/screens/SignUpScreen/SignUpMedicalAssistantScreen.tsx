    ...
    export const SignUpMedicalAssistantScreen = () => {
      ...
      const handleSubmit = async() => {
        ...
        if (!MedicalAssistantPassword) {
          errors.medical_assistant_password = 'Medical assistant password is required';
        } else if (MedicalAssistantPassword.length < 6) {
          errors.medical_assistant_password = 'Password must be at least 6 characters long';
        }
      ...
      return (
        <View style={styles.container}>
          ...
          />
          {formErrors.medical_assistant_name && <Text style={styles.error}>{formErrors.medical_assistant_name}</Text>}
          <CustomInput
            ...
            secureTextEntry={false}
          />
          {formErrors.medical_assistant_email && <Text style={styles.error}>{formErrors.medical_assistant_email}</Text>}
          <CustomInput
            ...
            secureTextEntry
          />
          {formErrors.medical_assistant_password && <Text style={styles.error}>{formErrors.medical_assistant_password}</Text>}
